...
export default class Stake extends Component {
  ...
  getFee = () => {
    ...
    rpc.get_table_rows({
      ...
      key_type: 'i128',
      index_position: 2,
      lower_bound: '0x83c48bde1205347001e4ddd44c571f78',
      upper_bound: '0x83c48bde1205347001e4ddd44c571f78',
      limit: 1,
    }).then((results) => {
      this.setState({
        fee: results.rows[0],
  ...
  transact = async () => {
    ...
    //fields['amount'] = fields['amount'] * 1000000000;
    //fields['max_fee'] = fields['max_fee'] * 1000000000;
    const { ual: { activeUser } } = this.props
    try {
